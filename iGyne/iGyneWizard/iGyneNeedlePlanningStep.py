...
class iGyneNeedlePlanningStep( iGyneStep ) :
  ...
  def createUserInterface( self ):
    ...
    if 1==1:     #  ("if" is here to have a fold code option...)
      ...
      self.label.setText((""))
      #pathToImage = slicer.modules.igyne.path.replace("igyne.py","Resources/Template/TemplateSheet.png")
      pathToImage = slicer.modules.igyne.path.replace("iGyne/iGyne.py","iGyne/Resources/Template/TemplateSheet.png")
